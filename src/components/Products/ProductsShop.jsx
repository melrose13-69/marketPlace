            ...
            <div className={ s.products }>
                <div className='container'>
                    <div className={ `${ s.inner } section` }>
                        <ProductsShopSort changePageSize={ changePageSize } pageControls={ pageControls }
                                          totalProducts={ totalProducts } changeSort={ changeSort }/>
                        <div className={ s.wrapper }>
                            { productsList.map( ( p, index ) =>
                                (index >= (pageControls.currentPageSize * (pageControls.currentPage - 1))
                                    && index < (pageControls.currentPageSize * pageControls.currentPage))
