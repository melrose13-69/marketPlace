...
export const createField = ( validators, { type, name, value }, placeholder, Component, ref ) => {
    return <Field validate={ validators } type={ type } value={value} name={ name } placeholder={ placeholder } component={ Component } ref={ref && ref}/>;
};